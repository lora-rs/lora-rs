    ...
    IV: InterfaceVariant + 'static,
{
    ...
    pub(super) async fn sub_set_standby(
        ...
        self.brd_write_command(OpCode::SetStandby, &[mode.value()])
            .await?;
    ...
    pub(super) async fn sub_calibrate_image(
        ...
        self.brd_write_command(OpCode::CalibrateImage, &cal_freq)
            .await?;
        Ok(())
    }
    ...
    pub(super) async fn sub_set_dio_irq_params(
        ...
        self.brd_write_command(OpCode::CfgDIOIrq, &buffer)
            .await?;
        Ok(())
    }
    ...
    pub(super) async fn sub_get_irq_status(
        ...
        self.brd_read_command(OpCode::GetIrqStatus, &mut irq_status)
            .await?;
    ...
    pub(super) async fn sub_set_dio2_as_rf_switch_ctrl(
        ...
        self.brd_write_command(OpCode::SetRFSwitchMode, &[enable as u8])
            .await?;
        Ok(())
    }
    ...
    pub(super) async fn sub_set_dio3_as_tcxo_ctrl(
        ...
        self.brd_write_command(OpCode::SetTCXOMode, &buffer)
            .await?;
    ...
    pub(super) async fn sub_set_rf_frequency(
        ...
        self.brd_write_command(OpCode::SetRFFrequency, &buffer)
            .await?;
        Ok(())
    }
    ...
    pub(super) async fn sub_set_tx_params(
        ...
        if self.brd_get_radio_type() == RadioType::SX1261 {
            ...
            self.brd_read_registers(Register::TxClampCfg, &mut tx_clamp_cfg)
                .await?;
            tx_clamp_cfg[0] = tx_clamp_cfg[0] | (0x0F << 1);
            self.brd_write_registers(Register::TxClampCfg, &tx_clamp_cfg)
                .await?;
    ...
    pub(super) async fn sub_set_modulation_params(
        ...
        if self.modulation_params.is_some() {
            ...
            self.brd_write_command(OpCode::SetModulationParams, &buffer)
                .await?;
            Ok(())
        } else {
    ...
    pub(super) async fn sub_set_packet_params(
        ...
        if self.packet_params.is_some() {
            ...
            self.brd_write_command(OpCode::SetPacketParams, &buffer)
                .await?;
            Ok(())
        } else {
    ...
    pub(super) async fn sub_clear_irq_status(
        ...
        self.brd_write_command(OpCode::ClrIrqStatus, &buffer)
            .await?;
        Ok(())
    }
