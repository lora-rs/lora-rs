...
//! * Wire fields are the owned types from [`super::types`], so byte order
...
use super::data::DataFrameType;
use super::join::CfList;
use super::types::{DevAddr, DevEui, DevNonce, JoinEui, JoinNonce, NetId};
use super::Error;
...
impl DataFrame<'_> {
    ...
    pub fn build_into<'a, C: CryptoFactory>(
        ...
        let total =
            MHDR_LEN + fhdr_len + f_port.map_or(0, |_| 1) + frm.len() + MIC_LEN;
